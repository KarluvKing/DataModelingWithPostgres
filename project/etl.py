...
"""
This procedure processes a song file whose filepath has been
...
"""
This procedure processes a log file whose filepath has been
provided as an arugment.
It extracts time data records information in order to store it into
the time table.
It also extracts user data record information in order to store it into
the user table.
In the end extracts song and artists record information in order to store it
...
def process_log_file(cur, filepath):
    ...
    t.dt.weekday
    column_labels = (
    "Timestamp","Hour","Day","Week of the Year","Month","Year","Weekday")
...
"""
This procedure processes all json files whose filepath has been provided
as an arugment.
Processes the data from json files whose filepath has been provided as
an argument.
Calls the functions process_song_file and process_log_file to extract the
necessary data.
...
"""
It creates the connection with the database and calls the functions to
process the files.
